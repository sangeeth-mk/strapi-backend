...
export interface ApiRecordRecord extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    break_end: Schema.Attribute.DateTime &
      Schema.Attribute.DefaultTo<'2024-12-07T18:30:00.000Z'>;
    break_start: Schema.Attribute.DateTime &
      Schema.Attribute.DefaultTo<'2024-12-07T18:30:00.000Z'>;
    check_in: Schema.Attribute.DateTime &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'2024-12-08T04:00:00.000Z'>;
